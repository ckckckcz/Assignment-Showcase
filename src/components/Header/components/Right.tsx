  ...
  return (
    <div className="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
      {userData.map((user, index) => (
        <figure key={user.id} className={`flex flex-col items-left justify-left p-8 text-left bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 ${index % 2 === 0 ? "md:rounded-t-lg" : "md:rounded-b-lg"}`}>
          <blockquote className="mb-4 text-gray-500 lg:mb-8 dark:text-gray-400 text-left">
            ...
            <p className="my-4">{user.quote.text}</p>
          </blockquote>
